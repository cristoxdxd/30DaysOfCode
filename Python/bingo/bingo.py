...
def PlayComplete():
    ...
    while not end:
        ...
        for i in range(nPlayers):
            ...
            matriz = checkBingo(cartones[i][0], numero)
            mostrarTablero(matriz, (5,5))
            if matriz[0][0] == 'X' and matriz[0][1] == 'X' and matriz[0][2] == 'X' and matriz[0][3] == 'X' and matriz[0][4] == 'X' and matriz[1][0] == 'X' and matriz[1][1] == 'X' and matriz[1][2] == 'X' and matriz[1][3] == 'X' and matriz[1][4] == 'X' and matriz[2][0] == 'X' and matriz[2][1] == 'X' and matriz[2][2] == 'X' and matriz[2][3] == 'X' and matriz[2][4] == 'X' and matriz[3][0] == 'X' and matriz[3][1] == 'X' and matriz[3][2] == 'X' and matriz[3][3] == 'X' and matriz[3][4] == 'X' and matriz[4][0] == 'X' and matriz[4][1] == 'X' and matriz[4][2] == 'X' and matriz[4][3] == 'X' and matriz[4][4] == 'X':
                print(f'Jugador {i+1} Ganaste! Completaste el cartón')
                end = True
                break
